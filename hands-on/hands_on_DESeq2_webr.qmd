...
## TO RENDER .qmd file FOR PUBLISHING on github.io ##
vi _quarto.yml
touch .nojekyll
quarto render hands_on_limma_webr.qmd 
git add docs
git commit -m "Publish site to docs/"
git push

# Set up on repository that docs/ folder is used for publishing on github pages 
...
## DE analysis
#webr::install('locfit')
#install.packages('locfit', repos = c('https://andyliaw-mrk.r-universe.dev', 'https://cloud.r-project.org'))
...
#library(edgeR)
install.packages('GenomeInfoDb', repos = c('https://bioc.r-universe.dev', 'https://cloud.r-project.org'), dependencies = FALSE)
install.packages('SummarizedExperiment', repos = c('https://bioc.r-universe.dev', 'https://cloud.r-project.org'))
install.packages('DESeq2', repos = c('https://bioc.r-universe.dev', 'https://cloud.r-project.org'))
library(DESeq2)

webr::install("DESeq2",
  repos=c("https://repo.r-wasm.org/","https://webr.bioconductor.org/3.18"))
