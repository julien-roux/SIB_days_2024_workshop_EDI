...
Today we will load directly the reprocessed data from the [recount3 project](http://rna.recount.bio/docs/index.html)

![](wrench-and-hammer.png) Connect to the [recount3 study explorer](https://jhubiostatistics.shinyapps.io/recount3-study-explorer/) and look for our dataset (accession "SRP218156").
...
## Add grouping variable (grouping 2 factors together)
## (and order levels in a logical way)
dge$samples$group <- factor(paste0(dge$samples$treatment, ".", dge$samples$sex), levels=c("Vehicle.female", "Tamoxifen.female", "Vehicle.male", "Tamoxifen.male"))
...
topTable(fit2, coef="Male_vs_female", n=10, sort.by="P") # X and Y chromosome genes
topTable(fit2, coef="Tamoxifen_effet_male", n=10, sort.by="P")
topTable(fit2, coef="Tamoxifen_effet_female", n=10, sort.by="P")
topTable(fit2, coef="Interaction", n=10, sort.by="P") ## Nothing significant
```
